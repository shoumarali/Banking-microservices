...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity serverHttpSecurity){
        ...
        serverHttpSecurity.authorizeExchange( exchanges -> {
            ...
            exchanges.pathMatchers("banking/accounts/**").hasRole("ACCOUNTS");
            exchanges.pathMatchers("banking/loans/**").hasRole("LOANS");
            exchanges.pathMatchers("banking/cards/**").hasRole("CARDS");
